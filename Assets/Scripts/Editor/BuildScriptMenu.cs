...
namespace UnityBuilderAction
{
	...
	public class BuildScriptMenu
	{
        ...
        [MenuItem("Tools/Build WebGL/... Target asm.js")]
        public static void BuildWebGLTargetAsmJS()
        {
            PlayerSettings.WebGL.linkerTarget = WebGLLinkerTarget.Asm; // not Wasm
        }

		[MenuItem("Tools/Build WebGL/... Memory Size 96")]
		public static void BuildWebGLSetMemory96()
		{
			PlayerSettings.WebGL.memorySize = 96;
		}

		static void UseCommonSettings()
        {
			BuildWebGLTargetAsmJS();
			BuildWebGLSetMemory96();
		}
